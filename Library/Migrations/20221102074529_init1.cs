        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BooksTitle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BooksCategory = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BooksAvailableQuantity = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
